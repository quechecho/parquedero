...
public class total extends javax.swing.JPanel {
    ...
    TxtNumVeh1.setBorder(null);
    TxtNumVeh2.setBorder(null);
    TxtNumVeh3.setBorder(null);
    TxtNumVeh4.setBorder(null);
    TxtNumVeh5.setBorder(null);
    TxtNumVeh6.setBorder(null);
    TxtNumVeh7.setBorder(null);

    TxtValVeh1.setBorder(null);
    TxtValVeh2.setBorder(null);
    TxtValVeh3.setBorder(null);
    TxtValVeh4.setBorder(null);
    TxtValVeh5.setBorder(null);
    TxtValVeh6.setBorder(null);
    TxtValVeh7.setBorder(null);

    TxtPorVeh1.setBorder(null);
    TxtPorVeh2.setBorder(null);
    TxtPorVeh3.setBorder(null);
    TxtPorVeh4.setBorder(null);
    TxtPorVeh5.setBorder(null);
    TxtPorVeh6.setBorder(null);
    TxtPorVeh7.setBorder(null);
    TxtTotalCosto.setBorder(null);
    TxtTotalVeh.setBorder(null);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("     Salidas totales");
