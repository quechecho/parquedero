...
public class parqueadero {
    ...
    public parqueadero(String ideCli, String apeCli, String nomCli, int tipVeh,  float horaEntrada, float minutoEntrada, float minutoSalida,  float horaSalida, float pagoRecibido, float cambio, float valhoras,  float costo)
     {
        this.ideCli = ideCli;
        this.apeCli = apeCli;
        this.nomCli = nomCli;
